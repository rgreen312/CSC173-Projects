...
void NorGate_print(Gate* this) {
	BinaryGate_print(this, "NOR");
}
void NorGate_update(Gate* this) {
	Value_setValue(this->update, !Value_getValue(this->inputs[0]) && !Value_getValue(this->inputs[1]));
}
Gate* new_Nor(Value *v1, Value *v2) {
	Gate* this = new_BinaryGate();
	this->inputs[0] = v1;
	this->inputs[1] = v2;
...
void NandGate_print(Gate* this) {
	BinaryGate_print(this, "NAND");
}
void NandGate_update(Gate* this) {
	Value_setValue(this->update, !(Value_getValue(this->inputs[0]) && Value_getValue(this->inputs[1])));
}
Gate* new_Nand(Value *v1, Value *v2) {
	Gate* this = new_BinaryGate();
	this->inputs[0] = v1;
	this->inputs[1] = v2;
