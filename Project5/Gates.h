...
extern void NorGate_print(Gate* this);
extern void NorGate_update(Gate* this);
extern Gate* new_Nor(Value *v1, Value *v2);
extern void NandGate_print(Gate* this);
extern void NandGate_update(Gate* this);
extern Gate* new_Nand(Value *v1, Value *v2);
